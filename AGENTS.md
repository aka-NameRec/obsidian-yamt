...
<!-- Fragments: core/base, core/git-workflow, core/architecture, core/error-handling, process/retrieval-routing, tools/project-memory, process/design-first-collaboration, process/reasoning-hygiene, process/autonomy-boundaries, process/structured-artifacts, process/session-hygiene, process/agent-usage-hygiene, stacks/typescript -->
